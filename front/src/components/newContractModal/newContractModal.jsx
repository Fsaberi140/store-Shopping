import React, { useEffect, useState } from "react"; // productDatails, Modal- request
...
const NewCartModal = ({ show, handleClose, reservedDates, handleSubmit }) => {
  // date range
  ...
  function onSubmitAndValidate(e) {
    e.preventDefault();
    if (startDate && endDate) handleSubmit(date);
